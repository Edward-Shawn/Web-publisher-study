            ...
            <div class="join_box">
                <form action="php/insert_member.php" method="post" name="member_form">
                    ...
                    <p class="clear email_box">
                        ...
                        <input type="text" name="email1" class="col_con " placeholder="your Email Site">
                        <span class="col_con">@</span>
                        <input type="text" name="email2" class="col_con" placeholder="your Email Site">
                    </p>
