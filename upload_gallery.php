    ...
    <div class="wrap">
      ...
      <section class="upload_section">
            <div class="center">
                ...
                <form action="php/image_insert.php" method="post" enctype="multipart/form-data" name="form_data" class="form_data clear">
                    <div class="upload_title clear">
                        <label for="title">Title</label>
                        <input type="text" id="title" name="title" accept='image/*' placeholder="Image's title...">
                    </div>
                    ...
                    <div class="upload_left">
                        <div class="image_box">
                            ...
                            <input type="file" id="thumbnail" class="upload_hidden" accept='image/*' name="thumb">
                        </div>
                    ...
                    <div class="upload_right">
                        <div class="image_box">
                            ...
                            <input type="file" id="large_img" accept='image/*' class="upload_hidden" name="large">
                        </div>
